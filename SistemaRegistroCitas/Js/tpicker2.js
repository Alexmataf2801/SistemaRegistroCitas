...
$(function(){
	...
	$('.minup').click(function(){
		if(fmi=30){fmi;updatetime();}else{fmi=0;updatetime();}
	});
	$('.mindown').click(function(){
		if(fmi=0){fmi;updatetime();}else{fmi=0;updatetime();}
	});

...
namespace Entidades.BaseDatos
{
    ...
    public partial class BDSistemaRegistroCitasEntities : DbContext
    {
        ...
        public virtual int paActualizarDatosXIdEmpresa(string nombre, string contacto, string descripcion, string direccion, Nullable<int> idEmpresa)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paActualizarDatosXIdEmpresa", nombreParameter, contactoParameter, descripcionParameter, direccionParameter, idEmpresaParameter);
        }
        ...
        public virtual int paDesactivarActivarEmpresasControlDeAdministracion(Nullable<int> idEmpresa, Nullable<bool> estado)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paDesactivarActivarEmpresasControlDeAdministracion", idEmpresaParameter, estadoParameter);
        }
        ...
        public virtual int paEliminarEmpresasControlDeAdministracion(Nullable<int> idEmpresa)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paEliminarEmpresasControlDeAdministracion", idEmpresaParameter);
        }
        ...
        public virtual int paIniciarlizarEmpresa(string nombreEmpresa, Nullable<int> idPlan, Nullable<System.DateTime> fechaProximoPago, string nombreUsuario, string primerApellidoUsuario, string segundoApellidoUsuario, string correoElectronicoUsuario, string identificacionUsuario, Nullable<int> telefonoUsuario, Nullable<bool> generoUsuario, string contrasena)
        {
            ...
            var fechaProximoPagoParameter = fechaProximoPago.HasValue ?
                new ObjectParameter("FechaProximoPago", fechaProximoPago) :
                new ObjectParameter("FechaProximoPago", typeof(System.DateTime));
    
            var nombreUsuarioParameter = nombreUsuario != null ?
                new ObjectParameter("NombreUsuario", nombreUsuario) :
                new ObjectParameter("NombreUsuario", typeof(string));
    
            var primerApellidoUsuarioParameter = primerApellidoUsuario != null ?
                new ObjectParameter("PrimerApellidoUsuario", primerApellidoUsuario) :
                new ObjectParameter("PrimerApellidoUsuario", typeof(string));
    
            var segundoApellidoUsuarioParameter = segundoApellidoUsuario != null ?
                new ObjectParameter("SegundoApellidoUsuario", segundoApellidoUsuario) :
                new ObjectParameter("SegundoApellidoUsuario", typeof(string));
    
            var correoElectronicoUsuarioParameter = correoElectronicoUsuario != null ?
                new ObjectParameter("CorreoElectronicoUsuario", correoElectronicoUsuario) :
                new ObjectParameter("CorreoElectronicoUsuario", typeof(string));
    
            var identificacionUsuarioParameter = identificacionUsuario != null ?
                new ObjectParameter("IdentificacionUsuario", identificacionUsuario) :
                new ObjectParameter("IdentificacionUsuario", typeof(string));
    
            var telefonoUsuarioParameter = telefonoUsuario.HasValue ?
                new ObjectParameter("TelefonoUsuario", telefonoUsuario) :
                new ObjectParameter("TelefonoUsuario", typeof(int));
    
            var generoUsuarioParameter = generoUsuario.HasValue ?
                new ObjectParameter("GeneroUsuario", generoUsuario) :
                new ObjectParameter("GeneroUsuario", typeof(bool));
    
            var contrasenaParameter = contrasena != null ?
                new ObjectParameter("Contrasena", contrasena) :
                new ObjectParameter("Contrasena", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paIniciarlizarEmpresa", nombreEmpresaParameter, idPlanParameter, fechaProximoPagoParameter, nombreUsuarioParameter, primerApellidoUsuarioParameter, segundoApellidoUsuarioParameter, correoElectronicoUsuarioParameter, identificacionUsuarioParameter, telefonoUsuarioParameter, generoUsuarioParameter, contrasenaParameter);
        }
        ...
        public virtual int paInsertarEmpresa(string nombre, Nullable<int> telefono, string logo, string contacto, Nullable<bool> estado, string direccion, string usuarioCreacion)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paInsertarEmpresa", nombreParameter, telefonoParameter, logoParameter, contactoParameter, estadoParameter, direccionParameter, usuarioCreacionParameter);
        }
        ...
        public virtual ObjectResult<paObtenerDatosDeEmpresasXIdControlDeAdminitracion_Result> paObtenerDatosDeEmpresasXIdControlDeAdminitracion(Nullable<int> idEmpresa)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paObtenerDatosDeEmpresasXIdControlDeAdminitracion_Result>("paObtenerDatosDeEmpresasXIdControlDeAdminitracion", idEmpresaParameter);
        }
        ...
        public virtual ObjectResult<paObtenerTodasLasEmpresasControlDeAdminitracion_Result> paObtenerTodasLasEmpresasControlDeAdminitracion()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paObtenerTodasLasEmpresasControlDeAdminitracion_Result>("paObtenerTodasLasEmpresasControlDeAdminitracion");
        }
        ...
        public virtual int paInsertarUsuario(string nombre, string primerApellido, string segundoApellido, string identificacion, string correoElectronico, Nullable<int> telefono, Nullable<bool> genero, Nullable<bool> terminosYCondiciones, Nullable<int> idRol, ObjectParameter idUsuario, ObjectParameter respuesta)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            var terminosYCondicionesParameter = terminosYCondiciones.HasValue ?
                new ObjectParameter("TerminosYCondiciones", terminosYCondiciones) :
                new ObjectParameter("TerminosYCondiciones", typeof(bool));
